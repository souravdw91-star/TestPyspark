"""Generate a sample sales CSV for local development.

Running this script creates `data/raw/sales.csv` with synthetic sales data.
"""
...
with open("data\\raw\\sales.csv", "w", newline="") as f:
    ...
    for i in range(1, 1001):
        ...
        # Use a consistent year but simulate random transaction dates.
